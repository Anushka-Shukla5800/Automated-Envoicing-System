...
def prepro():
    ...
    image = cv2.imread('Sample_Invoice_2.jpeg')
...
def output(content):
    ...
    with open('Invoice_template_output.csv', newline='') as f:  # CSV to Pdf form
        ...
        #save pdf in downlaod folder and pass name to config.finalfile
        #config.finalfile = "download/Akshat_Certificate.pdf"
        pdf.output('ITR4.pdf', 'F')
